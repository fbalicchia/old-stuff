...
import it.balyfix.streaming.function.LatencyTimeoutFunction;
import it.balyfix.streaming.function.LatencyWindowFunction;
import it.balyfix.streaming.function.SerializableFunction;
import it.balyfix.streaming.function.TimestampExtractorFunction;
import it.balyfix.streaming.predicate.JSONObjectPredicateMatchEquals;
import it.balyfix.streaming.predicate.JSONObjectPredicateMatchRegex;
import it.balyfix.streaming.session.JSONSessionMonitoring;
...
public class TimeoutMonitoringTest
{
	...
	public void testTimeoutMonitoring() throws Exception {
		...
		SerializableFunction<JSONObject, Long> timestampExtractor = new TimestampExtractorFunction("timestamp", "yyyy-MM-dd HH:mm:ss.SSSSSS");
    ...
    {
        private static final long serialVersionUID = 5664768052888059033L;
