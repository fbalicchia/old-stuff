...
import it.balyfix.streaming.function.JSONObjectExtractor;
import it.balyfix.streaming.function.JSONObjectTimestampExtractor;
import it.balyfix.streaming.function.SerializableFunction;
import it.balyfix.streaming.function.SerializableFunction2;
import it.balyfix.streaming.predicate.JSONObjectPredicate;
...
public class JSONSessionMonitoring
{
	...
	public static DataStream<JSONObject> createSessionMonitoring(
		...
		final SerializableFunction<JSONObject, Long> timestampExtractor,
		final long eventDelay,
		final long timeout,
        SerializableFunction2<JSONObject, JSONObject, JSONObject> windowFunction,
        SerializableFunction<JSONObject, JSONObject> timeoutFunction) {
