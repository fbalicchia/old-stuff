...
import it.balyfix.streaming.function.SerializableFunction2;
...
public class SessionWindowFunction<IN, OUT, KEY> implements WindowFunction<IN, OUT, KEY, GlobalWindow>, ResultTypeQueryable<OUT>
{
    ...
    private static final long serialVersionUID = 8825920404313117929L;

    private final SerializableFunction<IN, Boolean> isSessionStart;
	private final SerializableFunction<IN, Boolean> isSessionEnd;
	private final SerializableFunction<IN, Long> timestampExtractor;
	private final SerializableFunction2<IN, IN, OUT> windowFunction;
	private final SerializableFunction<IN, OUT> timeoutFunction;
	private final long timeout;
	private final TypeInformation<OUT> outTypeInformation;

	public SessionWindowFunction(
		SerializableFunction<IN, Boolean> isSessionStart,
		SerializableFunction<IN, Boolean> isSessionEnd,
		SerializableFunction<IN, Long> timestampExtractor,
		SerializableFunction2<IN, IN, OUT> windowFunction,
		SerializableFunction<IN, OUT> timeoutFunction,
		long timeout,
		Class<OUT> outClass) {
