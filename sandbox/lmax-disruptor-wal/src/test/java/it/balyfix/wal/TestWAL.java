 ...
 * under the License.
 */
package it.balyfix.wal;

import com.google.common.base.Preconditions;
import com.google.common.collect.Lists;
import com.google.common.io.Files;
import it.balyfix.disruptor.journal.wal.WAL;
import it.balyfix.disruptor.journal.wal.WALEntry;
import it.balyfix.disruptor.journal.wal.WALReplayResult;
import java.io.File;
...
public class TestWAL {
  ...
  public void setup() throws IOException {
    ...
    wal = new WAL<>(dataDir, Text.class);
  }
  @After
  ...
  public void testRoll() throws IOException, InterruptedException {
    wal.close();
    wal = new WAL<>(dataDir, Text.class, 0L, 0L, 0L, 1L);
    long seqid = 0;
    List<String> expected = strings(100);
    for(String s : expected) {
      wal.writeEntry(new WALEntry<>(new Text(s), ++seqid));
      Thread.sleep(1);
